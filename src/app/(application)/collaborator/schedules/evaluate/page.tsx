      ...
      <div className="flex flex-col gap-6">
        <div className="bg-gradient-to-r from-primary to-primary/50 p-5 rounded-lg">
          ...
          <p className="font-normal text-sm text-white">
            A sua opinião é muito importante para nós. Avalie a sessão e
        ...
        <div className="flex flex-col mt-10">
          ...
          <p className="font-normal text-sm text-[#828282] mb-4">
            O seu comentário pode ser exibido no perfil do profissional e ajudar
            outras pessoas. O envio é opcional.
          </p>
