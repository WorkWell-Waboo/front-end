                      ...
                      <DialogContent className="sm:max-w-[450px] px-8 pb-8 pt-10">
                        <DialogHeader className="relative">
                          ...
                          <DialogDescription className="text-center text-[#4f4f4f] text-xs leading-[1.1]">
                            A sua sessão com o especialista Sandra Amaral foi
                            reagenda para o dia 10/04/2025 às 15h30min. Confirma
                            a alteração?
                          </DialogDescription>
                        </DialogHeader>
                          ...
                          <Select>
                            ...
                            <SelectContent>
                              <SelectGroup>
                                ...
                                <SelectItem value="horario1">
                                  Horário 1
                                </SelectItem>
                                <SelectItem value="horario2">
                                  Horário 2
                                </SelectItem>
                                <SelectItem value="horario3">
                                  Horário 3
                                </SelectItem>
                                <SelectItem value="horario4">
                                  Horário 4
                                </SelectItem>
                                <SelectItem value="horario5">
                                  Horário 5
                                </SelectItem>
                              </SelectGroup>
                            </SelectContent>
              ...
              <div className="flex flex-col gap-2" key={historic.id}>
                ...
                <div className="px-8 py-4 rounded-lg flex items-center gap-5 border-b-2 h-full bg-white border-b-primary">
                  ...
                  <div className="flex gap-4">
                    ...
                    <Button asChild>
                      <Link href="/schedules/evaluate">Avaliar sessão</Link>
                    </Button>
                  </div>
                </div>
              </div>
