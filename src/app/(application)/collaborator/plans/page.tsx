  ...
  const plans = [
    {
      ...
      sessions: 1,
      description: "Perfeito para quem deseja o primeiro contato com a plataforma.",
      coin: "€",
      price: "200,00",
    },
    {
      ...
      sessions: 4,
      description: "Para quem a um acompanhamento inicial com qualidade e flexibilidade.",
      coin: "€",
      price: "800,00",
    },
    {
      ...
      name: "Plano Premium",
      sessions: 8,
      description: "Ideal para quem deseja um acompanhamento consistente e aprofundado.",
      coin: "€",
      price: "1.500,00",
    },
  ]
    ...
    <main className="p-10 flex flex-col gap-4">
                      ...
                      <DialogContent className="sm:max-w-[450px] px-8 pb-8 pt-10">
                        ...
                        <div className="block">
                          <p className="text-[#4f4f4f] text-sm leading-[1.1] font-normal mb-2">
                              A Psicologia é uma ciência que estuda o comportamento humano, os processos mentais e emocionais, ajudando as pessoas a compreenderem melhor os seus desafios e a desenvolverem estratégias para lidar com eles.<br/>
                              Na WoW, as consultas de Psicologia são conduzidas por profissionais especializados em diferentes áreas, desde a saúde mental e emocional até ao desempenho profissional e bem-estar.<br/>
                              Quer esteja a passar por momentos de stress, ansiedade, dificuldades emocionais, desafios no trabalho ou questões pessoais, um psicólogo pode ajudá-lo a encontrar equilíbrio e desenvolver estratégias eficazes para melhorar a sua qualidade de vida.
                            </p>
                            ...
                            <ul className="space-y-1 mb-3">
                              <li className="flex items-center gap-1">
                                ...
                                <span className="text-[#4f4f4f] text-sm leading-[1.1] font-normal">Gestão do stress e da ansiedade</span>
                              </li>
                              <li className="flex items-center gap-1">
                                <Check className="text-[#464646] h-3 w-3"/>
                                <span className="text-[#4f4f4f] text-sm leading-[1.1] font-normal">Depressão e questões emocionais</span>
                              </li>
                              <li className="flex items-center gap-1">
                                <Check className="text-[#464646] h-3 w-3"/>
                                <span className="text-[#4f4f4f] text-sm leading-[1.1] font-normal">Autoestima e desenvolvimento pessoal</span>
                              </li>
                              <li className="flex items-center gap-1">
                                <Check className="text-[#464646] h-3 w-3"/>
                                <span className="text-[#4f4f4f] text-sm leading-[1.1] font-normal">Relacionamentos interpessoais</span>
                              </li>
                              <li className="flex items-center gap-1">
                                <Check className="text-[#464646] h-3 w-3"/>
                                <span className="text-[#4f4f4f] text-sm leading-[1.1] font-normal">Saúde mental no trabalho</span>
                              </li>
                              <li className="flex items-center gap-1">
                                <Check className="text-[#464646] h-3 w-3"/>
                                <span className="text-[#4f4f4f] text-sm leading-[1.1] font-normal">Psicologia positiva e bem-estar</span>
                              </li>
                            </ul>
                        </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          {plans.map((plan)=>(
          <div className="flex flex-col gap-4 justify-between p-4 bg-white rounded-md" key={plan.id}>
            <div className="block">            
              <h3 className="text-primary font-medium text-xl">
                {plan.name}
              </h3>
              <span className="font-normal text-md text-[#4F4F4F]">{plan.sessions >= 1 ? `${plan.sessions} sessão` : `${plan.sessions} sessões`} </span>
              <hr className="border-[#4F4F4F] my-2"/>
              <p className="font-normal text-sm text-[#4F4F4F] mb-2">{plan.description}</p>
              <div className="flex gap-1 items-center text-primary font-medium">
                ...
                {plan.price.split(",")[1] && (
                  <span className="text-lg -mt-2">,{plan.price.split(",")[1]}</span>
                )}
              </div>
            </div>
