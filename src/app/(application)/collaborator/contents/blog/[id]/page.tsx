...
function CollaboratorContentsBlogPost() {
	...
	return (
      ...
      <div className="flex gap-2 font-semibold text-lg text-[#4f4f4f]">
			...
			<Image src={PhotoBlog} alt="foto blog" quality={100} className="w-full h-70 object-cover rounded-lg mb-4"/>
			...
			<ScrollArea className="w-full h-[300] text-sm font-light text-black">
				<p>
